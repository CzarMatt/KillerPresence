package com.devmobility.killerpresence.circleprogress;
...
public class CircularProgressButton extends Button {
    ...
    private StrokeGradientDrawable createDrawable(int color) {
        GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.progress_background).mutate();
